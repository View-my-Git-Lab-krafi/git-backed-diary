...
def create_entry():
    ...
    file_name_input = input("Enter a file name for the diary entry: ")
...
def main():
    ...
    try:
        ...
        print("If you want to reset remove .passwd_test.txt and .passwd.txt, also remember that you will become unable to access your old notes.")
        print("If you are able to set your old correct password you will able to acess your file again")
        exit()
    while True:
